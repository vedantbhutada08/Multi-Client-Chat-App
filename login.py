...
def login():
    ...
    def log_func(*args):
        ...
        data_base = sql.connect(host='localhost',port=3306,user='root',passwd='123456789',database='login_app')
        c = data_base.cursor()
...
def register():
    ...
    def reg_func(*args):
        ...
        data_base = sql.connect(host='localhost',user='root',passwd='123456789',database='login_app')
        c = data_base.cursor()
